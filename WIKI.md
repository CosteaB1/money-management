...
- **Backend: 4 test projects** — Domain / Application / Infrastructure / Api. Domain **219** + Application **487** verified live 2026-07-01; the Infrastructure + Api integration suites (require Postgres; ~107 + ~140 at the last QA count) bring the backend total to ~950. See QA.md for the live full-suite number. Build is warning-free with `TreatWarningsAsErrors`.
